/**
 * LiquidEther - WebGL fluid dynamics background effect.
 * Creates an interactive liquid simulation that responds to mouse movement.
 * Adapted from reactbits.dev LiquidEther component for Next.js/TypeScript.
 *
 * Props:
 * - colors: Array of hex color strings for the fluid palette
 * - className: Additional CSS classes
 * - style: Inline styles
 * - resolution: Simulation resolution multiplier (lower = better performance)
 * - mouseForce/cursorSize: Control mouse interaction strength and area
 * - autoDemo: Enable autonomous fluid movement when idle
 */
'use client'
...
`
    ...
    class Pressure extends ShaderPass {
      ...
      update(opts: { vel: any; pressure: any }) {
        this.uniforms.velocity.value = opts.vel.texture
