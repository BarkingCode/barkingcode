/**
 * Orb - 3D animated sphere with audio-reactive shader effects.
 * Uses React Three Fiber + custom GLSL shaders for a visual representation
 * of voice agent state (thinking, listening, talking).
 *
 * Props:
 * - colors: Tuple of two hex color strings for the gradient ramp
 * - agentState: Visual state ("thinking" | "listening" | "talking" | null)
 * - volumeMode: "auto" for simulated volume or "manual" with input/output refs
 * - className: Wrapper div className override
 */
"use client"
